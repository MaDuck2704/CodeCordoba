...
public:
    ...
    void Opciones()
    {
        ...
        while (continuar)
        {
            ...
            std::cout << "Ingresa 8: para descender a un Director Académico a usuario" << std::endl;
            ...
            case 6:
                ...
                if (organizador_.cambiarEstado1(nombre_))
                {
            ...
            case 8:
                ...
                cout << "Estos son los Directores Académicos actuales: " << endl;

                imprimirUsuarios();
                cout << "" << endl;
                cout << "Introduzca el nombre del Director Academico" << endl;
                while (nombre_.empty())
                {
                    std::getline(std::cin, nombre_);
                }
                if (organizador_.cambiarEstado2(nombre_))
                {
                    std::cout << "Director Académico descendido con exito. " << std::endl;
                }
                else
                {
                    std::cout << "Director Académico no coincide con ninguno existente. " << std::endl;
                }
                break;
